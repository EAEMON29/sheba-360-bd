...
const Footer = () => {
    ...
    return (
        <footer className="bg- text-gray-300 pt-16 pb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 border-b border-gray-700 pb-10">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4 mt-6">
                            <a href="#" className="text-gray-300 hover:text-blue-500 transition duration-300" aria-label="Facebook">
                                <Facebook size={24} />
                            </a>
                            <a href="#" className="text-gray-300 hover:text-secondary transition duration-300" aria-label="Instagram">
                                <Instagram size={24} />
                            </a>
                            <a href="#" className="text-gray-300 hover:text-blue-400 transition duration-300" aria-label="Twitter">
                                <Twitter size={24} />
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <form onSubmit={handleSubscribe} className="flex flex-col space-y-3">
                            <input
                                ...
                                className="input input-bordered w-full rounded-lg bg-white/10 border-gray-600 text-white placeholder-gray-400 focus:border-blue-500 focus:ring-secondary"
                                required
                            />
                            <button type="submit" className="btn text-blue-900 font-bold hover:opacity-90 transition duration-300">
